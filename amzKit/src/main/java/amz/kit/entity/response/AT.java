...
import amz.kit.entity.response.http.ATResponse;
...
public class AT {
    ...
    private final AmzAddress creator;
    private final AmzAddress id;
    private final AmzValue balance;
    private final AmzValue minimumActivation;
    private final AmzValue previousBalance;
    ...
    public AT(ATResponse atResponse) {
        ...
        this.creator = AmzAddress.fromEither(atResponse.getCreator());
        this.id = AmzAddress.fromEither(atResponse.getAt());
        this.balance = AmzValue.fromPlanck(atResponse.getBalanceNQT());
        this.minimumActivation = AmzValue.fromPlanck(atResponse.getMinActivation());
        this.previousBalance = AmzValue.fromPlanck(atResponse.getPrevBalanceNQT());
    ...
    public AT(BrsApi.AT at) {
        ...
        this.creator = AmzAddress.fromId(at.getCreator());
        this.id = AmzAddress.fromId(at.getId());
        this.balance = AmzValue.fromPlanck(at.getBalance());
        this.minimumActivation = AmzValue.fromPlanck(at.getMinActivation());
        this.previousBalance = AmzValue.fromPlanck(at.getPreviousBalance());
    ...
    public AmzValue getMinimumActivation() {
        return minimumActivation;
    }

    public AmzValue getPreviousBalance() {
