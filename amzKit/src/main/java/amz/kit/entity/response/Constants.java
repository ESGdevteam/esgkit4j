...
import amz.kit.entity.response.http.ConstantsResponse;
import amz.kit.entity.response.http.TransactionSubtypeResponse;
import amz.kit.entity.response.http.TransactionTypeResponse;
...
public class Constants {
    ...
    private final AmzID genesisBlockId;
    private final AmzAddress genesisAccountId;
    private final TransactionType[] transactionTypes;

    public Constants(int maxBlockPayloadLength, int maxArbitraryMessageLength, AmzAddress genesisAccountId, AmzID genesisBlockId, TransactionType[] transactionTypes) {
    ...
    public Constants(ConstantsResponse constantsResponse) {
        ...
        this.genesisBlockId = AmzID.fromLong(constantsResponse.getGenesisBlockId());
        this.genesisAccountId = AmzAddress.fromEither(constantsResponse.getGenesisAccountId());
    ...
    public Constants(BrsApi.Constants constants) {
        ...
        this.genesisBlockId = AmzID.fromLong(constants.getGenesisBlock());
        this.genesisAccountId = AmzAddress.fromId(constants.getGenesisAccount());
    ...
    public AmzAddress getGenesisAccountId() {
        return genesisAccountId;
    }

    public AmzID getGenesisBlockId() {
