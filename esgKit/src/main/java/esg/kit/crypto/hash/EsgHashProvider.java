...
public class EsgHashProvider extends Provider {

    private static final String NAME = "EsgHashProvider";
    private static final double VERSION = 1.0;
    private static final String INFO = "A Shabal-256 MessageDigest provider";

    public static void init() {
        Security.addProvider(new EsgHashProvider());
    }

    private EsgHashProvider() {
